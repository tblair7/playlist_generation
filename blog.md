# Analyzing my taste in music over the years
...
End of the night.... ENTIRE DATA SET COMPLETE! Now it's time to move onto the more exciting parts of plotting the data, working up the waveforms, and doing machine learning with the data!
